...
package org.wso2.event.adaptor.testIn.internal.ds;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.osgi.service.component.ComponentContext;
import org.wso2.carbon.event.input.adaptor.core.InputEventAdaptorFactory;
import org.wso2.event.adaptor.testIn.TestInEventAdaptorFactory;
...
public class TestInEventAdaptorServiceDS {
    ...
    protected void activate(ComponentContext context) {
        ...
        try {
            ...
            log.info("Successfully deployed the TestIn input event adaptor service");
        } catch (RuntimeException e) {
            log.error("Can not create the TestIn input event adaptor service ", e);
        }
    }
